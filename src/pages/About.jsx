...
const TECH_STACK = [
  ...
  { name: 'file-saver',      role: 'Trigger browser file downloads', pkg: 'file-saver' },
  ...
  { name: 'react-dropzone',  role: 'Drag-and-drop file upload zones', pkg: 'react-dropzone' },
  { name: 'react-router-dom', role: 'Client-side page routing',    pkg: 'react-router-dom' },
    ...
    <div className="about-container container py-5">
      ...
      <Section title="What It Does">
        <p>
          ...
          <strong>encryption</strong> to hide files inside ordinary images
          using two independent layers of security:
        </p>
        <ul className="about-list">
          <li>
            <strong>Layer 1 — Steganography:</strong> hides the existence of
            the data by writing it into the least significant bits of pixel
            RGB channels. The output image is visually indistinguishable from
            the original.
          </li>
          <li>
            <strong>Layer 2 — Encryption (optional):</strong> protects the
            data itself with AES-256 so that even if someone knows to look for
            hidden data, they cannot read it without the password.
          </li>
        </ul>
        <p>
